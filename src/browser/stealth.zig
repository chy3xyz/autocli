...
/// JavaScript that patches common browser automation detection vectors.
/// Should be injected early into pages to hide signs of automation.
pub const STEALTH_JS: []const u8 =
    \\\(() => {
